# Releasing strands-compose-agentcore
...
|---------------|------|---------|
| `fix:` | patch | `fix: handle empty session ID` |
| `feat:` | minor | `feat: add health check endpoint` |
| `feat!:` / `BREAKING CHANGE:` | major | `feat!: remove legacy proxy API` |
