# Contributing to strands-compose-agentcore
...
We welcome you to use [GitHub Issues](https://github.com/strands-compose/bedrock-agentcore/issues) to report bugs or suggest features.

When filing an issue, please check [existing issues](https://github.com/strands-compose/bedrock-agentcore/issues) first and try to include:

- A reproducible test case or series of steps
- The version of strands-compose-agentcore being used
...
These principles guide every design decision. When contributing, please keep them in mind:

1. **Strands-first** — if strands or strands-compose provides it, use it; don't wrap unnecessarily
...
6. **Thin wrapper** — translate AgentCore conventions to strands-compose calls, then get out of the way
...
If you discover a potential security issue in this project we ask that you notify us via [GitHub Security Advisories](https://github.com/strands-compose/bedrock-agentcore/security/advisories/new). Please do **not** create a public GitHub issue.
